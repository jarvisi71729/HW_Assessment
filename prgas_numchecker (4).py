...
difficulty = int(input("Which difficulty would you like to play out of the three options: "
...
#     min_num = round(random.uniform(1, 50), 1)
#     max_num = round(random.uniform(50, 100), 1)
#
# else:
#     min_num = round(random.uniform(-50, 0), 2)
#     max_num = round(random.uniform(0, 100), 2)
#
# print(difficulty)